    ...
    <section className="text-center text-white ">
      ...
      <section className="grid gap-4 sm:grid-cols-[auto_auto]">
        ...
        <section className="bg-white/20 backdrop-blur-sm p-2 rounded-2xl grid grid-cols-2 items-center">
          ...
          <span className="text-4xl">{tempSwitch}</span>
          <div>
        ...
        {/* Seccion inferior */}
        <section className=" bg-white/20 backdrop-blur-sm p-2 rounded-2xl grid grid-cols-3 items-center py-4 sm:grid-cols-1 text-[18px]">
